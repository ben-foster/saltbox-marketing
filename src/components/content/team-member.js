...
const TeamMember = ({ member }) => {
    return (
        ...
        >
            ...
            <p className="font-semibold text-gray-150 text-xl" dangerouslySetInnerHTML={{ __html: member.title }}></p>
            <p className="font-light text-md" dangerouslySetInnerHTML={{ __html: member.acf.job_title }}></p>
        </Link>
    );
};
