    ...
    <div className="p-4">
        <div className="flex flex-col w-80 h-96 p-6 bg-white rounded-lg shadow">
            ...
            <div className="flex flex-row items-center">
                <img className="w-8 h-8 mr-4" src="https://wordpress.saltbox.solutions/wp-content/uploads/2020/01/ppc-icon-color.svg" alt=""/>
            ...
            <div 
                ...
                className="text-xs"
            />
            <Link className="font-bold text-blue-700 w-full text-center mt-auto" to={post.link.replace("https://wordpress.saltbox.solutions", "")}>
                Learn more
            </Link>
        </div>
    </div>
