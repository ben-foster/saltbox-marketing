    ...
    return (  
        <svg className={className} width="628" height="353" viewBox="0 0 628 353" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="PPC_Animated">
                ...
                <g id="Paid Search Ad">
                    <animate 
                        id="Paid_Search_Ad_be_transparent" 
                        attributeType="xml"
                        attributeName="fill-opacity" 
                        begin="Organic_Results_translate.begin"
                        end="Organic_Results_translate.end"
                        from="0"
                        to="0" 
                        dur="2s"
                        fill="freeze" 
                    />
                    <animate 
                        id="Paid_Search_Ad_turn_opaque" 
                        attributeType="xml"
                        attributeName="fill-opacity" 
                        begin="Organic_Results_translate.end"
                        from="0"
                        to="1" 
                        dur="1.2s"
                        fill="freeze" 
                    />
                    <rect id="Ad Indicator" x="85" y="94" width="9" height="8" fill="#1CD4D4">
                        <animate 
                            id="Ad_Indicator_be_transparent" 
                            attributeType="xml"
                            attributeName="fill-opacity" 
                            begin="Organic_Results_translate.begin"
                            end="URL_Box_translate.end"
                            from="0"
                            to="0"
                            fill="freeze" 
                        />
                        <animate 
                            id="Ad_Indicator_turn_opaque" 
                            attributeType="xml"
                            attributeName="fill-opacity" 
                            begin="URL_Box_translate.end"
                            from="0"
                            to="1" 
                            dur="1s"
                            fill="freeze"
                            onend={() => document.getElementById('PPC_Animated').classList.remove('on')}
                        />
                    </rect>
                    <rect id="URL Box" x="99" y="94" width="80" height="8" fill="#5BD0FB">
                        <animateTransform 
                            id="URL_Box_begin_offset"
                            attributeName="transform"
                            type="translate"
                            from="-14 0"
                            to="-14 0"
                            begin="Organic_Results_translate.begin"
                            end="Paid_Search_Ad_turn_opaque.end"
                            repeatCount="0"
                            fill="freeze"
                        />
                        <animateTransform 
                            id="URL_Box_translate"
                            attributeName="transform"
                            type="translate"
                            from="-14 0"
                            to="0 0"
                            begin="Paid_Search_Ad_turn_opaque.end"
                            dur="0.7s"
                            repeatCount="0"
                            fill="freeze"
                        />
                    ...
                    <rect id="Rectangle 66" x="99" y="177" width="81" height="6" fill="#5BD0FB"/>
                ...
                <g id="Organic Results">
                    <animateTransform 
                        id="Organic_Results_translate"
                        attributeName="transform"
                        type="translate"
                        from="0 -102"
                        to="0 0"
                        ...
                        fill="freeze"
                    />
                    <g id="Organic Result 1">
                        <rect id="Rectangle 69" x="85" y="196" width="89" height="8" fill="#DDE6EE"/>
                        <rect id="Rectangle 70" x="85" y="225" width="294" height="8" fill="#DDE6EE"/>
                        <rect id="Rectangle 71" x="85" y="209" width="276" height="12" fill="#DDE6EE"/>
                    </g>
                    <g id="Organic Result 2">
                        <rect id="Rectangle 72" x="85" y="247" width="112" height="8" fill="#DDE6EE"/>
                        <rect id="Rectangle 73" x="85" y="276" width="291" height="8" fill="#DDE6EE"/>
                        <rect id="Rectangle 74" x="85" y="260" width="287" height="12" fill="#DDE6EE"/>
                    </g>
                    <g id="Organic Result 3">
                        <rect id="Rectangle 75" x="85" y="298" width="89" height="8" fill="#DDE6EE"/>
                        <rect id="Rectangle 76" x="85" y="327" width="287" height="8" fill="#DDE6EE"/>
                        <rect id="Rectangle 77" x="85" y="311" width="265" height="12" fill="#DDE6EE"/>
                    </g>
                    <g id="Organic Result 4">
                        <rect id="Rectangle 69_2" x="85" y="349" width="89" height="8" fill="#DDE6EE"/>
                        <rect id="Rectangle 70_2" x="85" y="378" width="294" height="8" fill="#DDE6EE"/>
                        <rect id="Rectangle 71_2" x="85" y="362" width="276" height="12" fill="#DDE6EE"/>
                    </g>
                    <g id="Organic Result 5">
                        <rect id="Rectangle 72_2" x="85" y="400" width="112" height="8" fill="#DDE6EE"/>
                        <rect id="Rectangle 73_2" x="85" y="429" width="291" height="8" fill="#DDE6EE"/>
                        <rect id="Rectangle 74_2" x="85" y="413" width="287" height="12" fill="#DDE6EE"/>
                    </g>
                    <g id="Organic Result 6">
                        <rect id="Rectangle 75_2" x="85" y="451" width="89" height="8" fill="#DDE6EE"/>
                        <rect id="Rectangle 76_2" x="85" y="480" width="287" height="8" fill="#DDE6EE"/>
                        <rect id="Rectangle 77_2" x="85" y="464" width="265" height="12" fill="#DDE6EE"/>
                    </g>
                </g>
            </g>
        </svg>
