    ...
    return (
        <Layout>
                                ...
                                <>
                                    { title === "Web Analytics Solutions" && (
                                        <div ref={ref} className="z-50 -mt-16 -mb-48">
                                            <AnalyticsAnimation className="w-256 h-auto mx-auto shadow-md mb-4" animateOnHover={animateOnHover} inView={inView} />
                                        </div>
                                    )}
                                    { title === "Pay-per-Click Advertising" && (
                                        <div ref={ref} className="z-50 -mt-16 -mb-48">
                                            <PPCAnimation className="w-256 h-auto mx-auto shadow-md mb-4" animateOnHover={animateOnHover} inView={inView} />
                                        </div>
                                    )}
                                    { title === "Search Engine Optimization" && (
                                        <div ref={ref} className="z-50 -mt-16 -mb-48">
                                            <SEOAnimation className="w-256 h-auto mx-auto shadow-md mb-4" animateOnHover={animateOnHover} inView={inView} />
                                        </div>
                                    )}
                                </>
                            )}
            ...
            <div className="bg-white">
                ...
                <div className="container mx-auto flex flex-col md:flex-row justify-center pb-12">
                    <div className="flex items-center justify-center w-full md:w-auto p-12 order-first md:order-last">
